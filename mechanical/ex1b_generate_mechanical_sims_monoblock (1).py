...
'''
================================================================================
Example: Generate Perturbed 3D Monoblock Mechanical Field Simulations using MOOSEHERDER and Stratified Sobol Sampling of parameter space.
...
if __name__ == "__main__":
    base_input_file = Path("example_monoblock.i")
    output_dir = Path("mechanical_simulations_monoblock")
