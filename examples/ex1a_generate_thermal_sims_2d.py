'''
================================================================================
Example: Generate Perturbed 2D Plate Temperature Field Simulations using MOOSEHERDER and Stratified Sobol Sampling of parameter space.
...
def main():
    ...
    moose_input = Path(Path.cwd(), 'example_2d_plate.i')
